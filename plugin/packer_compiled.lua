...
_G.packer_plugins = {
  ...
  ["gruvbox-baby"] = {
    config = { "\27LJ\2\n4\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\25colorschemes.gruvbox\frequire\0" },
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/gruvbox-baby",
  ...
  ["nvim-lspconfig"] = {
    after = { "trouble.nvim", "SchemaStore.nvim", "lsp_signature.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-notify"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-autopairs", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-colorizer.lua", "indent-blankline.nvim", "nvim-ts-rainbow" },
    loaded = true,
    only_config = true
  },
...
try_loadstring("\27LJ\2\n4\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\25colorschemes.gruvbox\frequire\0", "config", "gruvbox-baby")
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-colorizer.lua', 'lsp_signature.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
